...
def build_containers(ucloud_ip, upstream_registry, regseparator, pushurl, pushtag, container_name, arr, repotext, license_text):
    ...
    rhel_container = "%s%s%s:15.0" % (upstream_registry, regseparator,
                                       arr['rhel_container'])
...
ENV no_proxy="${no_proxy},%s"
    ...
    blob = blob + "RUN dnf config-manager --enable openstack-15-for-rhel-8-x86_64-rpms \n"
...
""" 
    ...
    container_array = {
        'horizon': {
            ...
            "osd_param_name": ["ContainerHorizonImageStein"],
            "user": 'neutron',
        ...
        'heat': {
            ...
            "osd_param_name": ["ContainerHeatEngineImageStein"],
            "user": 'neutron',
        ...
        'neutron-server': {
            ...
            "osd_param_name": ["ContainerNeutronApiImageStein", "ContainerNeutronConfigImageStein"],
            "user": 'neutron',
        ...
        'ciscoaci-lldp': {
            ...
            "osd_param_name": ["ContainerCiscoLldpImageStein"],
            "user": 'neutron',
        ...
        'opflex-agent': {
            ...
            "osd_param_name": ["ContainerOpflexAgentImageStein"],
            "user": 'neutron',
